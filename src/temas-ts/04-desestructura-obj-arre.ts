...
console.log(`Los segundos actuales son: ${reproductor.segundo}`)
console.log(`La canción actual es: ${reproductor.cancion}`)
console.log(`El cantante es: ${reproductor.detalles.autor}`)
console.log(`El años es: ${reproductor.detalles.year}`) */
...
console.log(`Los segundos actuales son: ${segundo}`)
